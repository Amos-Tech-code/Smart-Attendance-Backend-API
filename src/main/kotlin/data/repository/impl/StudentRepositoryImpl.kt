...
class StudentRepositoryImpl : StudentRepository {
    ...
    override suspend fun findByRegistrationNumber(regNo: String): Student? = transaction {
        StudentsTable
    ...
    override suspend fun findById(id: UUID): Student? = transaction {
        StudentsTable
    ...
    override suspend fun findByDeviceId(deviceId: String): Student? {
        return transaction {
    ...
    override suspend fun findDeviceByStudentId(studentId: UUID): Device? = transaction {
        DevicesTable
            .selectAll()
    ...
    override suspend fun createStudentWithDevice(
        student: Student,
    ): Student = transaction {
        // Insert student
    ...
    override suspend fun updateDevice(studentId: UUID, device: Device): Boolean = transaction {
        DevicesTable.insert {
            it[id] = device.id
    ...
    override suspend fun updateLastLogin(studentId: UUID, timestamp: LocalDateTime): Boolean = transaction {
    ...
    override suspend fun updateDeviceLastSeen(
        deviceId: String,
    ...
    override suspend fun flagSuspiciousLogin(studentId: UUID, device: DeviceInfo): Boolean = transaction {
